		...
		<footer class="px-16 py-10 text-white bg-green-800 md:py-12">
					...
					<ul
						...
						<li class="flex items-start gap-3">
							<span class="flex-shrink-0 w-5 h-5 mt-1">
								<img
									src="{{asset('assets/images/location-icon.png')}}"
									alt="Location"
						...
						<li class="flex items-start gap-3">
							<span class="flex-shrink-0 w-5 h-5 mt-1">
								<img
									src="{{asset('assets/images/phone-icon.png')}}"
									alt="Phone"
									class="object-contain w-full h-full" />
							</span>
						...
						<li class="flex items-start gap-3">
							<span class="flex-shrink-0 w-5 h-5 mt-1">
								<img
									src="{{asset('assets/images/email-icon.png')}}"
									alt="Email"
									class="object-contain w-full h-full" />
							</span>
						...
						<li class="flex items-start gap-3">
							<span class="flex-shrink-0 w-5 h-5 mt-1">
								<img
									src="{{asset('assets/images/skype icon.png')}}"
									alt="Skype"
									class="object-contain w-full h-full" />
							</span>
						...
						<li>
							<a href="#" class="flex items-center gap-2 hover:underline">
								...
								<span class="flex-shrink-0 w-4 h-4">
									<img
										src="{{asset('assets/images/solar_arrow-right-up-broken.png')}}"
			...
			<div
				...
				<div class="flex items-center gap-2">
					...
					>
					<img
						src="{{asset('assets/images/bdiclogo.png')}}"
						alt="BDIC Logo"
						class="w-10 h-auto" />
				</div>
			</div>
